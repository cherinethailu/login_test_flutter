...
class _LoginFormState extends State<LoginForm> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: Container(
          decoration: const BoxDecoration(color: Color(0xffF2F6FF)),
                              ...
                              child: TextButton(
                                  ...
                                  onPressed: () {
                                    ...
                                    if (form!.validate()) {
                                      print("Validate");
                                      print(
                                          "Channel method successfully invoked");
                                      String loginRespone = _login(
  ...
  Future<Object?> _login(String username, String password) async {
    ...
    try {
      ...
      print("Login response on flutter side:");
      print(data);
      return data;
